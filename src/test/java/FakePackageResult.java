...
public class FakePackageResult extends FakeTabulatedResult {
	...
	public FakePackageResult addTest(String className, String testMethod, TestStatus testStatus, String errorDetails, String errorStackTrace) {
		getClassResult(className).addTest(testMethod, testStatus, errorDetails, errorStackTrace);
		return this;
	}
