...
public class JsTreeUtilTest {
    ...
    public void requiresBuildsButHasJustOneTestCase() {
        ...
        results.addPackage(7, 1, packageFoo, "someUrl/");
        ...
        JSONObject method1Node = buildNode("method1: run #1", jsonArray(buildNA(9), method1Result), jsonArray());
    ...
    public void onePassedAndSkippedTestLeadsToPassed() {
        ...
        results.addPackage(1, 1, packageFoo, "someUrl/");
        ...
        JSONObject method1Node = buildNode("method1: run #1", jsonArray(method1Result), jsonArray());
        JSONObject method2Node = buildNode("method2: run #1", jsonArray(method2Result), jsonArray());
