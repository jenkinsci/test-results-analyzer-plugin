...
public class FakeClassResult extends FakeTabulatedResult {
	...
	public void addTest(String testMethod, TestStatus testStatus, String errorDetails, String errorStackTrace) {
		addTestResult(new FakeTestMethod(this, testMethod, testStatus, errorDetails, errorStackTrace));
	}
}
